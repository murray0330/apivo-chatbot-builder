...
"abc-medspa": {
  ...
  customCss: [
    "@media(max-width:768px){",
      ...
      "#aw-panel{bottom:70px!important;border-radius:16px 16px 0 0!important;right:0!important;left:0!important;width:100%!important;height:calc(100vh - 70px)!important;}",
      "#aw-backdrop{display:none;position:fixed;inset:0;background:rgba(0,0,0,.4);z-index:9999;}",
      "#aw-panel.aw-open~#aw-backdrop,#aw-backdrop.aw-show{display:block!important;}",
    "}",
  ].join(""),
  customJs: [
    ...
    "function awOpenFromHash(){",
      ...
      "}else{setTimeout(function(){",
        "var l2=document.getElementById('aw-launcher');",
        "if(l2&&l2.getAttribute('aria-expanded')==='false'){l2.click();awBackdrop.classList.add('aw-show');}",
      "},500);}",
    "}",
    "awOpenFromHash();",
