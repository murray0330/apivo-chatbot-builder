...
"#aw-input{flex:1;padding:10px 16px;border-radius:9999px;border:1px solid rgba(0,0,0,.08);background:#fafafa;font-size:1rem;color:#18181b;outline:none;font-family:inherit}",
